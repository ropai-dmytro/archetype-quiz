...
const AuthorPage: React.FC = () => {
  ...
  return (
    <div className="author-page">
      {/* Fern SVG background decoration */}
      ...
      <div className="author-container">
        {/* Hero Section */}
        <section ref={(el) => { sectionRefs.current[0] = el; }} className="author-hero scroll-reveal">
          <div className="author-hero-content">
            <div className="author-photo-large">
              <img src="/anna.png" alt="Анна Ропай" />
            </div>
            <h1 className="author-name-large">Анна Ропай</h1>
            <p className="author-title-large">Психолог і наставниця з особистого бренду</p>
            <div className="author-divider"></div>
          </div>
        </section>

        {/* About Section */}
        <section ref={(el) => { sectionRefs.current[1] = el; }} className="author-about scroll-reveal">
          <div className="about-card">
            ...
            <div className="about-content">
              ...
              <div className="credentials">
                ...
                <div className="credential-item">
                  <h3>Спеціалізація</h3>
                  <p>Архетипи, арт-терапія, психосоматика, особистий бренд</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section ref={(el) => { sectionRefs.current[2] = el; }} className="author-services scroll-reveal">
          <div className="services-header">
            ...
            <p className="services-subtitle">
              Індивідуальний підхід до кожного клієнта для максимального результату
            </p>
          </div>
        ...
        {/* Contact Section */}
        <section ref={(el) => { sectionRefs.current[3] = el; }} className="author-contact scroll-reveal">
