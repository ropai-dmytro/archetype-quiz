      ...
      <div className="content">
        ...
        <div ref={defRef} className="archetype-definition-block scroll-reveal">
          ...
          <div className="archetype-definition-description">
            Архетипи - це первинні образи, які існують у колективному несвідомому людства. (Карл Юнг)
          <br/><br/>

            Вони універсальні моделі досвіду, що проявляються у міфах, казках, снах, релігії, мистецтві й житті кожної людини.
            Це глибинні структури, через які ми сприймаємо світ, діємо в ньому й шукаємо сенс. <br/>
            Архетипи - це універсальні ролі і енергії, які формують наші бажання, страхи, вибори, спосіб мислення та стиль життя.
          </div>
        </div>
